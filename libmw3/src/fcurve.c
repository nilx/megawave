/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  Main changes :
  v1.6 (JF): added include <string> (Linux 2.6.12 & gcc 4.0.2)
  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
void mw_delete_point_fcurve(Point_fcurve point)
{
    ...
    {
        mwerror(ERROR, 0,
                "[mw_delete_point_fcurve] cannot delete : "
                "point_fcurve structure is NULL\n");
        return;
    }
    point_first = point;
    do
...
/* Copy all the points of a fcurve starting from a Point_fcurve into
 * another chain */
...
Point_fcurve mw_copy_point_fcurve(Point_fcurve in, Point_fcurve out)
{
    ...
    if (!out)
    {
        ...
        if (!out)
            mwerror(ERROR, 0,
                    "[mw_copy_point_fcurve] Not enough memory "
                    "to create a point_fcurve\n");
        return (NULL);
    }
...
void mw_delete_fcurve(Fcurve fcurve)
{
    ...
    {
        mwerror(ERROR, 0,
                "[mw_delete_fcurve] cannot delete : "
...
Fcurve mw_copy_fcurve(Fcurve in, Fcurve out)
{
    ...
    if (!out)
    {
        ...
        {
            mwerror(ERROR, 0,
                    "[mw_copy_fcurve] Not enough memory "
                    "to create a fcurve !\n");
            return (NULL);
        }
    }
    ...
    if (out->first == NULL)
    {
        ...
        mwerror(ERROR, 0,
                "[mw_copy_fcurve] Not enough memory to copy the fcurve\n");
        return (NULL);
    }
...
void mw_delete_fcurves(Fcurves fcurves)
{
    ...
    {
        mwerror(ERROR, 0,
                "[mw_delete_fcurves] cannot delete : "
