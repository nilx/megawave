...
void *_mw_alloc_wtrans1d(Wtrans1d wtrans, int level, int voice, int size, int complex, int sampling, int use_average);
...
void *_mw_wtrans1d_load_signal_wtrans(char *fname, char *type, Wtrans1d wtrans, Fsignal (*S)[50], char *Sname);
...
void _mw_uchar_to_float(register unsigned char *ptr_uchar, register float *ptr_float, int N);
void _mw_1x24XV_to_3x8_ucharplanes(register unsigned char *ptr, register unsigned char *ptr1, register unsigned char *ptr2, register unsigned char *ptr3, int N);
void _mw_3x8_to_1x24XV_ucharplanes(register unsigned char *ptr1, register unsigned char *ptr2, register unsigned char *ptr3, register unsigned char *ptr, int N);
...
Point_fcurve mw_point_curve_to_point_fcurve(Point_curve pcurve, Point_fcurve first_point);
Fcurve mw_curve_to_fcurve(Curve curve, Fcurve fcurve);
Point_curve mw_point_fcurve_to_point_curve(Point_fcurve pfcurve, Point_curve first_point);
Curve mw_fcurve_to_curve(Fcurve fcurve, Curve curve);
Point_fcurve mw_point_dcurve_to_point_fcurve(Point_dcurve pcurve, Point_fcurve first_point);
Fcurve mw_dcurve_to_fcurve(Dcurve dcurve, Fcurve fcurve);
Point_dcurve mw_point_fcurve_to_point_dcurve(Point_fcurve pfcurve, Point_dcurve first_point);
...
Cfmorpho_line mw_fmorpho_line_to_cfmorpho_line(Fmorpho_line ll, Cfmorpho_line cll);
Fmorpho_line mw_cfmorpho_line_to_fmorpho_line(Cfmorpho_line cll, Fmorpho_line ll);
Cfmorpho_line mw_cmorpho_line_to_cfmorpho_line(Cmorpho_line ll, Cfmorpho_line fll);
Cmorpho_line mw_cfmorpho_line_to_cmorpho_line(Cfmorpho_line fll, Cmorpho_line ll);
...
Cmorpho_sets mw_cmorpho_set_to_cmorpho_sets(Cmorpho_set is, Cmorpho_sets cmorpho_sets);
Cmorpho_set mw_cmorpho_sets_to_cmorpho_set(Cmorpho_sets cmorpho_sets, Cmorpho_set is);
