...
Ccimage mw_alloc_ccimage(Ccimage image, int nrow, int ncol)
{
    ...
    {
        mwerror(ERROR, 0,
                "[mw_alloc_ccimage] cannot alloc plane : "
                "ccimage structure is NULL\n");
        return (NULL);
    }
    ...
    {
        mwerror(ERROR, 0,
                "[mw_alloc_ccimage] Attempts to alloc a ccimage "
                "with null size\n");
        return (NULL);
    }

    if ((image->red != NULL) || (image->green != NULL)
        || (image->blue != NULL))
    {
        mwerror(ERROR, 0,
                "[mw_alloc_ccimage] Attempts to alloc a ccimage "
...
void mw_delete_ccimage(Ccimage image)
{
    ...
    {
        mwerror(ERROR, 0,
                "[mw_delete_ccimage] cannot delete : "
                "ccimage structure is NULL\n");
        return;
    }
...
void mw_getdot_ccimage(Ccimage image, int x, int y,
                       unsigned char *r, unsigned char *g, unsigned char *b)
{
    ...
    {
        mwerror(ERROR, 0,
                "[mw_getdot_ccimage] Point (%d,%d) out of image... "
                "Return (0,0,0)\n", x, y);
        *r = *g = *b = 0;
        return;
    }
    ...
    if (!image->red)
    {
        mwerror(WARNING, 0, "[mw_getdot_ccimage] NULL red plane... "
                "Return 0\n");
        *r = 0;
        return;
    }
...
void mw_copy_ccimage(Ccimage in, Ccimage out)
{
    ...
    {
        mwerror(ERROR, 0,
                "[mw_copy_ccimage] NULL input or output image "
...
unsigned char **mw_newtab_red_ccimage(Ccimage image)
{
    ...
    {
        mwerror(ERROR, 0,
                "[mw_newtab_red_ccimage] NULL image struct "
                "or NULL red plane\n");
        return (NULL);
    }
...
unsigned char **mw_newtab_green_ccimage(Ccimage image)
{
    ...
    {
        mwerror(ERROR, 0,
                "[mw_newtab_green_ccimage] NULL image struct "
                "or NULL green plane\n");
        return (NULL);
    }
...
unsigned char **mw_newtab_blue_ccimage(Ccimage image)
{
    ...
    {
        mwerror(ERROR, 0,
                "[mw_newtab_blue_ccimage] NULL image struct "
                "or NULL blue plane\n");
        return (NULL);
    }
