...
Cimage _mw_cimage_load_pm(char *file)
{
    ...
    if (fread(pm, PM_IOHDR_SIZE, 1, fp) == 0)
    {
        mwerror(ERROR, 0,
                ...
                "Not a PM format or file corrupted !\n", file);
        free(pm);
        fclose(fp);
        return (NULL);
    }
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_cimage_load_pm] File \"%s\" is not in the PM format\n",
                file);
        free(pm);
        fclose(fp);
        return (NULL);
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_cimage_load_pm] File \"%s\" is not "
                "in the CHAR PM fomat\n", file);
        free(pm);
        fclose(fp);
        return (NULL);
    }
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_cimage_load_pm] PM file \"%s\" cannot be loaded "
                "into a cimage\n", file);
        free(pm);
        fclose(fp);
        return (NULL);
...
short _mw_cimage_create_pm(char *file, Cimage image)
{
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_cimage_create_pm] NULL cimage or cimage plane\n");
        return (-2);
    }
...
Fimage _mw_fimage_load_pm(char *file)
{
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_fimage_load_pm] File \"%s\" is not in the PM format\"n",
                file);
        free(pm);
        fclose(fp);
        return (NULL);
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_fimage_load_pm] File \"%s\" is not "
                "in the FLOAT PM format\"n", file);
        free(pm);
        fclose(fp);
        return (NULL);
    }
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_fimage_load_pm] PM file \"%s\" cannot be loaded "
                "into a fimage\n", file);
        free(pm);
        fclose(fp);
        return (NULL);
...
short _mw_fimage_create_pm(char *file, Fimage image)
{
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_fimage_create_pm] NULL fimage or fimage plane\n");
        return (-2);
    }
...
Ccimage _mw_ccimage_load_pm(char *file)
{
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_ccimage_load_pm] File \"%s\" is not in the PM format\n",
                file);
        free(pm);
        fclose(fp);
        return (NULL);
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_ccimage_load_pm] File \"%s\" is not "
                "in the CHAR PM fomat\n", file);
        free(pm);
        fclose(fp);
        return (NULL);
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_ccimage_load_pm] PM file \"%s\" cannot be loaded "
                "into a ccimage\n", file);
        free(pm);
        fclose(fp);
        return (NULL);
...
short _mw_ccimage_create_pm(char *file, Ccimage image)
{
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_ccimage_create_pm] NULL ccimage or ccimage planes\n");
        return (-2);
    }
...
Cfimage _mw_cfimage_load_pm(char *file)
{
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_cfimage_load_pm] File \"%s\" is not in the PM format\n",
                file);
        free(pm);
        fclose(fp);
        return (NULL);
    ...
    switch (pm->pm_form)
    {                           /* Code FLOAT values and the color model */
    case PM_F_RGB:
    ...
    default:
        mwerror(INTERNAL, 0,
                "[_mw_cfimage_load_pm] File \"%s\" is not "
                "in the FLOAT PM fomat or unknown color model\n", file);
    }
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_cfimage_load_pm] PM file \"%s\" cannot be loaded "
                "into a cfimage\n", file);
        free(pm);
        fclose(fp);
        return (NULL);
...
short _mw_cfimage_create_pm(char *file, Cfimage image)
{
    ...
    {
        mwerror(INTERNAL, 0,
                "[_mw_cfimage_create_pm] NULL cfimage or cfimage planes\n");
        return (-2);
    }
