...
struct mw_args_info
{
  ...
  char * exec_arg;	/**< @brief executable code file name.  */
  char * exec_orig;	/**< @brief executable code file name original value given at command line.  */
  const char *exec_help; /**< @brief executable code file name help description.  */
