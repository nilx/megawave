/*
 * afile.c for megawave, section mwplight
 *
...
{
     fprintf(afile, "/* This A-file has been generated by ");
     fprintf(afile, "the megawave preprocessor.\n");
     fprintf(afile, "   It contains the source of ");
     fprintf(afile, "the run-time command '%s'.\n", module_name);
     fprintf(afile, "*/\n\n");
}
