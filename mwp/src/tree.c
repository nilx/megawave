...
#define MSG_ERROR_USAGE_ICTYPE \
     "Invalid usage for C_id=\"%s\" : internal inconsistency between ICtype (not NULL) and Min (NULL)"
#define MSG_ERROR_USAGE_IC_FLAG \
     "Invalid usage for C_id=\"%s\" : interval checking is not allowed in flag option"
#define MSG_ERROR_USAGE_IC_OUT \
     "Invalid usage for C_id=\"%s\" : interval checking is not allowed in output"
#define MSG_ERROR_USAGE_IC_UNUSED \
     "Invalid usage for C_id=\"%s\" : interval checking is not allowed in notused argument"
...
#define MSG_ERROR_USAGE_HID_REQUIRED \
     "Invalid usage for C_id=\"%s\" : H_id is required for needed and optional arguments"
#define MSG_ERROR_USAGE_HID_FORBIDDEN \
     "Invalid usage for C_id=\"%s\" : H_id is not allowed in variable or not used arguments"
#define MSG_ERROR_USAGE_COMMENT \
     "Invalid usage for C_id=\"%s\" : incorrect comment"
#define MSG_ERROR_USAGE_DEFAULT_INPUT_FLAG \
     "Invalid usage for C_id=\"%s\" : default input value is not allowed in flag option"
#define MSG_ERROR_USAGE_DEFAULT_INPUT_NEEDED \
     "Invalid usage for C_id=\"%s\" : default input value is not allowed in needed argument"
...
#define MSG_ERROR_USAGE_DEFAULT_INPUT_VARIABLE \
     "Invalid usage for C_id=\"%s\" : default input value is not allowed in variable argument"
#define MSG_ERROR_USAGE_DEFAULT_INPUT_NOTUSED \
     "Invalid usage for C_id=\"%s\" : default input value is not allowed in notused argument"
#define MSG_ERROR_USAGE_IC_MISSING \
          "Invalid usage for C_id=\"%s\" : incorrect interval checking specification (only Min or Max specified)"
#define MSG_ERROR_USAGE_IC_INCONSISTENT \
     "Invalid usage for C_id=\"%s\" : internal inconsistency between ICtype (NULL) and Min (not NULL)"
#define MSG_ERROR_USAGE_IC_INCORRECT \
     "Invalid usage for C_id=\"%s\" : incorrect interval checking specification (Min >= Max)"
