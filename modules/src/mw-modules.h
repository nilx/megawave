...
void arencode2(int *Print, long int *Size, int *NSymb, long int *Cap_Histo, int *Predic, Fsignal Histo, int *Header, Fimage Input, double *Rate, Cimage Output);
...
void ardecode2(int *Print, int *NRow, int *NSymb, long int *Cap_Histo, int *Predic, Fsignal Histo, Cimage Input, double *Rate, Fimage Output);
