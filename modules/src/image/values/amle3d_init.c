...
/* mwcommand
 ...
 function = {"Compute initial data for the level line image
             interpolation scheme in the 3d case(AMLE)"};
 usage = {
   in->in
