...
static int one_thinning(unsigned char *A, unsigned char *O, int dy, int dx,
                        int ONE, int ZERO)
{
...
/* rot pi/2 */
                if (((uc == ZERO) &&
                     (cl == ONE) && (cr == ONE) && (dl == ONE) && (dc == ONE)
                     && (dr == ONE) && (ddl == ONE) && (ddc == ONE)
                     && (ddr == ONE)) || (((cr == ZERO) && (ull == ONE)
                                           && (ul == ONE) && (uc == ONE)
                                           && (cll == ONE) && (cl == ONE)
                                           && (dll == ONE) && (dl == ONE)
                                           && (dc == ONE))) || (((dc == ZERO)
                                                                 ...
                                                                 && (uur ==
                                                                     ONE)))
                    ||
                    (((cl == ZERO) && (uc == ONE) && (ur == ONE)
                      && (urr == ONE) && (cr == ONE) && (crr == ONE)
                      && (dc == ONE) && (dr == ONE) && (drr == ONE)))
                    ||
                    (((uc == ZERO) && (ur == ZERO) && (cr == ZERO)
                      && (cll == ONE) && (cl == ONE) && (dll == ONE)
                      && (dl == ONE) && (dc == ONE) && (ddll == ONE)
                      && (ddl == ONE) && (ddc == ONE))) || (((cr == ZERO)
                                                             && (dc == ZERO)
                                                             && (dr == ZERO)
                                                             && (uull == ONE)
                                                             && (uul == ONE)
                                                             ...
                                                             && (cl == ONE)))
                    ||
                    (((cl == ZERO) && (dc == ZERO) && (dl == ZERO)
                      && (uuc == ONE) && (uur == ONE) && (uurr == ONE)
                      && (uc == ONE) && (ur == ONE) && (urr == ONE)
                      && (cr == ONE) && (crr == ONE))) || (((cl == ZERO)
                                                            && (uc == ZERO)
                                                            && (ul == ZERO)
                                                            && (cr == ONE)
                                                            && (crr == ONE)
...
Cimage thinning(int *niter, char *inv, Cmovie M, Cimage imageI, Cimage imageO)
{
    ...
    {
        change =
            one_thinning(imageA->gray, imageO->gray, nrow, ncol, ONE, ZERO);
        if (change == 1)
        {
            mwdebug("iteration %d\n", i);
