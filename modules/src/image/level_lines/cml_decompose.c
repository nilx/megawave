...
static Cmorpho_line produce_lline(Color minvalue, Color maxvalue, unsigned char open)
{
...
static void
follow_closed_line(unsigned char **H, unsigned char **V, int ll, int cc, int sum, Cmorpho_line lline)
{
  Point_curve p0,p1;
