    ...
    for (l = 0; l < nz - 1; l++)
    {
        ...
        for (j = 0; j < ny; j++)
            for (i = 0; i < nx; i++)
            {
                ...
                {
                    Ex[adr] =
                        0.25 * (a111 - a011 + a101 - a001 + a110 - a010 +
                                a100 - a000);
                    Ey[adr] =
                        0.25 * (a111 - a101 + a011 - a001 + a110 - a100 +
                                a010 - a000);
                    Et[adr] =
                        0.25 * (a111 - a110 + a011 - a010 + a101 - a100 +
                                a001 - a000);
                }
            }
    }
            ...
            for (j = 0; j < ny; j++)
                for (i = 0; i < nx; i++)
                {
                    ...
                    else
                    {
                        ...
                        Ua[0][adr] =
                            0.16666 * (um0 + u01 + u10 + u0m) +
                            0.08333 * (umm + um1 + u11 + u1m);
                        Va[0][adr] =
                            0.16666 * (vm0 + v01 + v10 + v0m) +
                            0.08333 * (vmm + vm1 + v11 + v1m);
                    }
                }
