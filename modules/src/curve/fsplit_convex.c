...
Flists fsplit_convex(Flist in, Flists out, int *ncc, double *eps)
{
    ...
    float *p, *q, *pmax, *first, px1, py1, px2, py2, px3, py3, px4, py4, mx,
        my;
    double epsilon;
      ...
      /*** split curve ***/
        ...
        else
        {
            ...
            if (d1 == 0 || d2 == 0)
            {
                ...
                px3 = px4;
                py3 = py4;
                d2 = dir((double) px1, (double) py1, (double) px2,
                         (double) py2, (double) px3, (double) py3, epsilon);
                nr++;
            }
            else
