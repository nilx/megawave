                                ...
                                /* Original image */
{
    ...
    register float *ptrIR, *ptrIG, *ptrIB;
    /* Pointers to channels of Image */
    register float *ptrRR, *ptrRG, *ptrRB;
    /* Pointers to channels of Result */
  ...
  /*--- Copy the extracted sub-image on result ---*/
    ...
    for (l = 0; l < rdy;
         l++, ptrIR += dx - rdx, ptrIG += dx - rdx, ptrIB += dx - rdx)
        for (c = 0; c < rdx;
             c++, ptrIR++, ptrIG++, ptrIB++, ptrRR++, ptrRG++, ptrRB++)
        {
            *ptrRR = *ptrIR;
            *ptrRG = *ptrIG;
            *ptrRB = *ptrIB;
