This module provides a simple interface to the snakes algorithm, by calling
...
\bibitem{CCCD} V. Caselles, F. Catt\'e, B. Coll and F. Dibos, \em{A geometric model for active contours in image processing}, Numerische Mathematik, vol. 66, 1993, pp. 1-31.
\end{thebibliography}