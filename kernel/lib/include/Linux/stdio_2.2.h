/* For MegaWave2, all occurrences of "__format" have been removed 
   and extern definition of "sys_errlist[]" has been changed.
*/
...
extern int printf __P ((__const char *__restrict , ...));
...
extern int snprintf __P ((char *__restrict __s, size_t __maxlen,
			  __const char *__restrict , ...))
     __attribute__ ((__ (__printf__, 3, 4)));

extern int __vsnprintf __P ((char *__restrict __s, size_t __maxlen,
			     __const char *__restrict ,
			     _G_va_list __arg))
     __attribute__ ((__ (__printf__, 3, 0)));
...
extern int vasprintf __P ((char **__restrict __ptr,
     ...
     __attribute__ ((__ (__printf__, 2, 0)));
extern int __asprintf __P ((char **__restrict __ptr,
			    __const char *__restrict __fmt, ...))
     __attribute__ ((__ (__printf__, 2, 3)));
...
extern int scanf __P ((__const char *__restrict , ...));
...
extern int vfscanf __P ((FILE *__restrict __s,
			 __const char *__restrict ,
			 _G_va_list __arg))
     __attribute__ ((__ (__scanf__, 2, 0)));

/* Read formatted input from stdin into argument list ARG.  */
extern int vscanf __P ((__const char *__restrict , _G_va_list __arg))
     __attribute__ ((__ (__scanf__, 1, 0)));
