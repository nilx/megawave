/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   Vers. 1.8
   (C) 1993-99 Jacques Froment & Sylvain Parrino
...
extern void  MegaWaveDefOpt(void);
...
extern FILE *_mw_write_header_file(char *,char *);
...
/* Maximum Size of the MegaWave2 file types */
#define TYPE_SIZE 20

/* Size of MegaWave2 buffer */
#define MWBUFSIZ	BUFSIZ
...
/* For float, need to perform the flip by means of an unsigned long buffer 
   fptr : input has a pointer to a float
