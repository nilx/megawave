...
Ccmovie _mw_ccmovie_load_movie_old_format(NomFic,Type)
...
Ccmovie _mw_ccmovie_load_native(fname,Type)
...
Ccmovie _mw_ccmovie_load_movie(NomFic,Type)
...
short _mw_ccmovie_create_movie(NomFic,movie,Type)
