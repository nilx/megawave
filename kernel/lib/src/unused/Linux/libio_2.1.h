...
/* MODIFIED FOR MEGAWAVE2 : changed  "struct _IO_FILE" to "_IO_FILE" */
/* Define the user-visible type, with user-friendly member names.  */
typedef struct
{
   _IO_ssize_t (*read) __P ((_IO_FILE *, void *, _IO_ssize_t));
   _IO_ssize_t (*write) __P ((_IO_FILE *, const void *, _IO_ssize_t));
   _IO_fpos_t (*seek) __P ((_IO_FILE *, _IO_off_t, int));
  int (*close) __P ((_IO_FILE *));
