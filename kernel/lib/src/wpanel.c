...
int Wp_DrawButton(window,x,y,str,color)
Wframe *window; 
char *str;
int x,y,color;
{
...
/* draw scale bar */
void Wp_DrawScale(window,x,y,pos,div,length,color)
Wframe *window; 
int x,y,pos,div,length,color;
{
  int i;
