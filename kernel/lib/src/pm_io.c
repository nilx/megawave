...
Cimage _mw_cimage_load_pm(file)
...
short _mw_cimage_create_pm(file,image)
...
short _mw_fimage_create_pm(file,image)
...
Ccimage _mw_ccimage_load_pm(file)
...
short _mw_ccimage_create_pm(file,image)
...
Cfimage _mw_cfimage_load_pm(file)
...
short _mw_cfimage_create_pm(file,image)
