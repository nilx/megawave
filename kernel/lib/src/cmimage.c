...
Cmorpho_line mw_change_cmorpho_line(ll)
...
Cfmorpho_line mw_change_cfmorpho_line(ll)
...
Cmorpho_set mw_change_cmorpho_set(is)
...
Cmorpho_sets mw_change_cmorpho_sets(is)
...
void mw_cmorpho_sets_clear_stated(mss_first)
