...
Rim _mw_rim_load_megawave1(char * NomFic, char * Type, char Comment[])
{
     short   fic;                            /* fichier */
...
short _mw_rim_create_megawave1(char * NomFic, Rim image,
...
Rim _mw_rim_load_image(char * NomFic, char * Type, char Comment[])
{
     Rim image_rim;
     Img image_img;
...
short _mw_rim_create_image(char * NomFic, Rim image,
			   char * Type, char Comment[])
{
     Img image_img;
