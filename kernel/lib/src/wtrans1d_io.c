...
Wtrans1d _mw_load_wtrans1d_header(fname)
...
short _mw_create_wtrans1d_header(fname,wtrans)
...
void *_mw_wtrans1d_load_signal_wtrans(fname,type,wtrans,S,Sname)

char *fname; /* Name of the generic wavelet decomposition (Header Ascii file)*/
char *type;  /* External type of the wavelet coefficients files */
Wtrans1d wtrans;                           /* The Wtrans */
Fsignal S[mw_max_nlevel+1][mw_max_nvoice]; /* The signal */
char Sname[];    /* Name of the signal field (A,AP,D or DP) */
...
Wtrans1d _mw_wtrans1d_load_wtrans(fname,type)
...
void _mw_wtrans1d_create_signal_wtrans(fname,type,wtrans,S,Sname)
...
short _mw_wtrans1d_create_wtrans(fname,wtrans,type)
