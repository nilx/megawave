...
Img _mw_img_load_megawave1(NomFic,Type,Comment)
...
short _mw_img_create_megawave1(NomFic,image,Type,Comment)
...
Img _mw_img_load_image(NomFic,Type,Comment)
...
short _mw_img_create_image(NomFic,image,Type,Comment)
