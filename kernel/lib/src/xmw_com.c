...
short _mw_load_anytype(char * fname, char ftype[],
		       char comment[], void ** mwstruct,
		       char * mtype)
{
...
short _mw_save_anytype(char * fname, char ftype[], char ftype_force[],
		       char comment[], void * mwstruct, char * mtype)
{
...
void * _mw_convert_struct(void * mwstruct, char * mtype_in, char * mtype_out)
{
...
char ** _mw_list_of_convert_struct(char * mtype)
{
     if (strcmp(mtype,"cimage") == 0)
	  return(conv_cimage);
     if (strcmp(mtype,"fimage") == 0)
...
void _mw_delete_anytype(void * mwstruct, char * mtype)
{
     if (strcmp(mtype,"cimage") == 0)
     {
...
int _mw_get_info_anytype(void * mwstruct, char * mtype,
			 int * width, int * height, char * sname,
			 char * comment, void **R, void **G, void **B,
			 int * timer)
{ 
     if (strcmp(mtype,"cimage") == 0)
     {
...
void _mw_put_info_anytype(void * mwstruct, char * mtype,
			  int width, int height,
			  char * sname, char * comment, 
			  void * R, void * G, void * B, int ptype)
{ 
...
short _mw_copy_anytype(void * struct1, void ** struct2, char * mtype)
{
     if (strcmp(mtype,"cimage") == 0)
     {
