...
static void setnewout(void)
{
    ...
    if (NULL != (fname = getenv("MW_STDOUT")) && verbose_flg == FALSE)
    {
    ...
    if (NULL != (fname = getenv("MW_STDERR")) && verbose_flg == FALSE)
    {
 ...
 */
int _mw_main(int argc, char *argv[], char *envp[], Mwiline mwicmd[],
             int mwind)
{
